...
public class TempAgent extends Agent {
  ...
  @SyntheticMember
  public TempAgent(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public TempAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
