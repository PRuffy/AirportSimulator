...
public class BehaviorTypeSelector extends JDialog {
  ...
  protected BehaviorTypeSelector() {
    this.setTitle(LocalizedString.getString(BehaviorTypeSelector.class, "TITLE"));
    this.setModal(true);
    ...
    String label = LocalizedString.getString(BehaviorTypeSelector.class, "KINEMATIC_BUTTON");
