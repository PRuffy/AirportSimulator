...
public class Body_Walker extends Body_Mover {
  @DefaultValueSource
  public Body_Walker(final UUID id, final Shape2f<?> shape, final Frustum frustum, @DefaultValue("framework.environment.Body_Walker#NEW_0") final Point2f position, final String name) {
  ...
  @SyntheticMember
  public Body_Walker(final UUID id, final Shape2f<?> shape, final Frustum frustum, final String name) {
  ...
  @Pure
  @SyntheticMember
  public Body_Walker clone() {
    try {
      return (Body_Walker) super.clone();
