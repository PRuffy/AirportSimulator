...
import framework.environment.EnvObject;
...
public class QuadTreeNode<T extends EnvObject> {
  ...
  @DefaultValueSource
  public QuadTreeNode(@DefaultValue("framework.environment.QuadTreeNode#NEW_0") final QuadTreeNode<T> parent, final Rectangle2f box) {
    if ((parent != null)) {
  ...
  @DefaultValueUse("framework.environment.QuadTreeNode<T>,framework.math.Rectangle2f")
  @SyntheticMember
