...
public abstract class Body_IOT extends AgentBody {
  @Override
  @Pure
  @SyntheticMember
  public Body_IOT clone() {
    try {
      return (Body_IOT) super.clone();
   ...
   */
  @SyntheticMember
  public Body_IOT(final UUID id, final Shape2f<?> shape, final Frustum frustum) {
   ...
   */
  @SyntheticMember
  public Body_IOT(final UUID id, final Shape2f<?> shape, final float maxLinearSpeed, final float maxLinearAcceleration, final float maxAngularSpeed, final float maxAngularAcceleration, final Frustum frustum) {
