...
public class Borne extends Body_IOT {
  @DefaultValueSource
  public Borne(final UUID id, final Shape2f<?> shape, final Frustum frustum, @DefaultValue("framework.environment.Borne#NEW_0") final Point2f position, final String name) {
  ...
  @SyntheticMember
  public Borne(final UUID id, final Shape2f<?> shape, final Frustum frustum, final String name) {
