...
public class TimePercept extends AbstractTime implements Serializable, Cloneable {
  ...
  @DefaultValueSource
  @Pure
  public float getCurrentTime(@DefaultValue("framework.time.TimePercept#GETCURRENTTIME_0") final TimeUnit unit) {
  ...
  @DefaultValueSource
  @Pure
  public float getLastStepDuration(@DefaultValue("framework.time.TimePercept#GETLASTSTEPDURATION_0") final TimeUnit unit) {
  ...
  @SyntheticMember
  @Pure
  public final float getLastStepDuration() {
    return getLastStepDuration($DEFAULT_VALUE$GETLASTSTEPDURATION_0);
  }
  
  @SyntheticMember
  private final static long serialVersionUID = 904984924L;
}
