...
public interface Time extends Comparable<Time> {
   ...
   */
  @DefaultValueSource
  public abstract float getCurrentTime(@DefaultValue("framework.time.Time#GETCURRENTTIME_0") final TimeUnit unit);
   ...
   */
  @DefaultValueSource
  public abstract float getLastStepDuration(@DefaultValue("framework.time.Time#GETLASTSTEPDURATION_0") final TimeUnit unit);
